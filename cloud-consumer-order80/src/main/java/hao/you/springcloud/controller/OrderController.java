...
import hao.you.springcloud.lb.LoadBalancer;
...
public class OrderController {
    ...
    public Object discovery() {
        ...
        for (ServiceInstance instance : instances) {
            log.info(instance.getHost() + "---------" + instance.getInstanceId() + "---------" + instance.getScheme() + "---------" + instance.getServiceId() + "---------" + instance.getUri() + "---------" + instance.getPort());
        }
